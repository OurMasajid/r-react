...
//         <h1 className="display-3" style={{ color: 'darkslategrey' }}>{masjidState.data.about[0].fullName}</h1>
//         <div className="lead">Address</div>
//       </div>
//       if (masjidState.data.news)
//       {
//         <div id="news" className="bg-success py-3 text-white" v-if="masjidState.data.news">
//           <h2 className="display-1 text-center">News</h2>
//           <hr className="star-light" />
//           <div className="container container-small newses">
//             {/* <div className="card border-light bg-success my-1" v-for="(item, index) in masjidState.data.news">
...
//       <div id="about" className="bg-light text-center py-3" v-if="masjidState.data.about[0].about">
//         <h2 className="display-1">About Us</h2>
//         <hr className="star-light" />
//         <div className="container container-medium">
//           <p>{masjidState.data.about[0].about}</p>
//         </div>
//       </div>
//       <div id="donate" className="text-center py-3" v-if="masjidState.data.donate">
...
//         </div>
//       </div>
//       <div id="contact" className="bg-light py-3" v-if="masjidState.data.contact">
...
//         </div>
//       </div>
//       <div id="signup" className="bg-dark py-3 text-center" v-if="masjidState.data.newsletter">
